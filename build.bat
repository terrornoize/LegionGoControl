...
cl %CXXFLAGS% LegionGoControl.cpp LegionGoCore.cpp LegionGoFrameLimiter.cpp "%BUILD_DIR%\LegionGoControl.res" /Fo"%BUILD_DIR%\\" /Fe"%CD%\LegionGoControl.exe" /link /MACHINE:X64 /SUBSYSTEM:WINDOWS /MANIFEST:EMBED /MANIFESTINPUT:"%CD%\app.manifest"
if errorlevel 1 exit /b 1
